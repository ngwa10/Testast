...
# -------------------------
COPY launcher.py test_screenshot.py core.py screen_logic.py telegram_listener.py telegram_callbacks.py core_utils.py shared.py win_loss.py logs.json debug_core.py /home/dockuser/
